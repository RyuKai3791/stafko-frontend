...
// Implement a new sidebar button called "Tracker". This new button should navigate to the tracker page. The tracker page should give the user a dropdown menu to select one project
  return (
    <div className="w-full">
      ...
      <div className="mt-4 flex items-center justify-between gap-2 md:mt-8">
        <Search placeholder="Search customers to filter" />
        <CreateCustomer />
      </div>
